# JupyterToHtml/JupyterToHtml.py at main · piyuanyuan1/JupyterToHtml · GitHub
# https://github.com/piyuanyuan1/JupyterToHtml/blob/main/JupyterToHtml.py
# https://blog.csdn.net/piyuanyuan/article/details/123073643?spm=1001.2101.3001.6661.1&depth_1-utm_relevant_index=1
# JupyterToHtml.py
import json
...
style_config = {
    ...
    'code_borer_radius' : '5px',                    # 边框圆角半径
    'code_borer_with' : '5px',                      # 边框宽度
    'code_line-height' : '2',                     # 行高
    ...
    'table_border' : '2px',                        # 边框，默认无边框：1px solid #000
...
def jupyterHtmlGet(file, target, config):
    source = ''
...
if __name__ == '__main__':
    jupyterHtmlGet(file = "/Users/hellox/Documents/Code/Vue-flask-master/jupyter_html/pandas_numpy.ipynb",     # 源文件
         target= "/Users/hellox/Documents/Code/Vue-flask-master/jupyter-html/pandas-numpy", # 生成的html文件名（不带后缀，默认保存在桌面）
